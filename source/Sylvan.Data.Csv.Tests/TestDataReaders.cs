...
{
	// copied from Sylvan.Data.DataReaderAdapter, but without the IDbColumnSchemaGenerator impl.
	abstract partial class BaseDataReaderAdapter : DbDataReader
	{
		...
		/// </summary>
		public BaseDataReaderAdapter(DbDataReader dr)
		{
			this.dr = dr;
		}
		...
		public override int GetValues(object[] values)
		{
			...
			var count = System.Math.Min(this.FieldCount, values.Length);
	...
	sealed class SchemalessDataReader : BaseDataReaderAdapter
	{
		public SchemalessDataReader(DbDataReader reader) : base(reader) { }
	...
	sealed class SchemaTableDataReader : BaseDataReaderAdapter
	{
		public SchemaTableDataReader(DbDataReader reader) : base(reader) { }
	...
	sealed class NullFieldTypeDataReader : BaseDataReaderAdapter
	{
		public NullFieldTypeDataReader(DbDataReader reader) : base(reader) { }
	...
	sealed class ObjectFieldTypeDataReader : BaseDataReaderAdapter
	{
		public ObjectFieldTypeDataReader(DbDataReader reader) : base(reader) { }
